...
public class LocacaoBuilder {
	...
	public static void inicializarDadosPadroes(LocacaoBuilder builder) {
		...
		elemento.setDataLocacao(new Date()); // passa a data atual 
	...
	public LocacaoBuilder atrasado() {
		elemento.setDataLocacao(DataUtils.obterDataComDiferencaDias(-4)); // quatro dias atrás 
		elemento.setDataRetorno(DataUtils.obterDataComDiferencaDias(-2)); // dois dias atrás 
		return this; // retorna a instância do elemento 
	}
